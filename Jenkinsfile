pipeline {
    ...
    stages {
            ...
            steps {
                withKubeConfig(caCertificate: '', clusterName: ' myAppp-eks-cluster', contextName: '', credentialsId: 'k8s', namespace: 'webapps', restrictKubeConfigAccess: false, serverUrl: 'https://F3719F7BA2BB38C9C609D6085DFDD5F5.gr7.us-east-1.eks.amazonaws.com') {
